...
fn test_assemble_arithmetic_i64() {
    ...
    let binary0 = helper_make_single_module_app(
        ...
        {
            // group 0
            add_i64(local_load_i64(a0), local_load_i64(a1))
            sub_i64(local_load_i64(a1), local_load_i64(a0))
            sub_i64(local_load_i64(a0), local_load_i64(a1))
            mul_i64(local_load_i64(a0), local_load_i64(a1))

            // group 1
            div_i64_s(local_load_i64(a1), local_load_i64(a2))
            div_i64_u(local_load_i64(a1), local_load_i64(a2))
            div_i64_s(local_load_i64(a2), local_load_i64(a1))
            div_i64_u(local_load_i64(a2), local_load_i64(a1))
            rem_i64_s(local_load_i64(a1), local_load_i64(a2))
            rem_i64_u(local_load_i64(a2), local_load_i64(a1))

            // group 2
            add_imm_i64(3, local_load_i64(a0))
            sub_imm_i64(3, local_load_i64(a0))
            add_imm_i64(3, local_load_i64(a2))
            sub_imm_i64(3, local_load_i64(a2))

            // group 3
            add_i64(imm_i64(0xffff_ffff_ffff_ffff_i64), imm_i64(0x2))
            mul_i64(imm_i64(0xf0e0_d0c0_b0a0_9080_i64), imm_i64(0x2))
            add_imm_i64(2, imm_i64(0xffff_ffff_ffff_ffff_i64))
            sub_imm_i64(2, imm_i64(0x1))
        }
        "#,
    );
...
fn test_assemble_arithmetic_f32() {
    ...
    let binary0 = helper_make_single_module_app(
        ...
        fn test(a0:f32, a1:f32) ->
            (f32, f32, f32, f32)
        {
            add_f32(local_load_f32(a0), local_load_f32(a1))
            sub_f32(local_load_f32(a1), local_load_f32(a0))
            mul_f32(local_load_f32(a0), local_load_f32(a1))
            div_f32(local_load_f32(a1), local_load_f32(a0))
        }
        "#,
    );
...
fn test_assemble_arithmetic_f64() {
    ...
    let binary0 = helper_make_single_module_app(
        ...
        fn test(a0:f64, a1:f64) ->
            (f64, f64, f64, f64)
        {
            add_f64(local_load_f64(a0), local_load_f64(a1))
            sub_f64(local_load_f64(a1), local_load_f64(a0))
            mul_f64(local_load_f64(a0), local_load_f64(a1))
            div_f64(local_load_f64(a1), local_load_f64(a0))
        }
        "#,
    );
